...
public class MusicBand implements Comparable<MusicBand> {
    ...
    public MusicBand(String name, Coordinates coordinates, Integer numberOfParticipants, String description, ZonedDateTime establishmentDate, MusicGenre genre, Album bestAlbum) {
